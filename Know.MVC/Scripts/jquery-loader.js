/// <reference path="ViewScripts/Global/Global.js" />
...
(function ($) {
    $.loader_ext = {
        defaults: {
            ...
            title: '',
            isOnly: true,
            imgUrl: GS_Path.GetUrl('/content/img/loading/') + 'loading[size].gif',
            onShow: function () {
            },
            onClose: function () {
            }
    ...
    $.loader = {
        tmpl: '<div class="loading_wrp"><div class="loading ${Class}"><img src="${Src}" /><p>${Title}</p></div></div>',
